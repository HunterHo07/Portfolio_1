...
(function () {
  ...
  var staticCopy = {
    en: {
      ...
      timelineCaptions: [
        ...
        ["Hackathon | Sui | Winner","Sui Winner Moment","Hackathon winner spotlight"],
        ...
        ["Achievement | IOTA | Winner", "IOTA Winner Stage", "Malaysia 2025 winner-stage moment"],
        ["Startup | Winner | Pitch", "Winner Pitch Stage", "Startup winner presentation moment"],
        ["Achievement | Winner | Stage", "Winner Spotlight Stage", "Event winner spotlight"],
        ["Team | Primitive | Meetup", "Primitive Team Meetup", "White-shirt group moment with the Primitive crew"],
        ["Team | Group | Culture", "Large Team Group Shot", "A bigger white-shirt group photo from the event floor"],
        ["Event | Automotive | Track", "Zeekr Track Moment", "Cars rolling under the Zeekr banner at sunset"],
        ["Event | Selfie | Memorabilia", "Signed Poster Selfie", "Holding a signed board in a cinema or mall setting"],
        ["Lifestyle | Skyline | Social", "Night Skyline Gathering", "Rooftop city lights and a relaxed evening crowd"],
        ["Workspace | Desk | Collectibles", "Desk with Collectibles", "A playful workspace full of plush toys and figurines"],
        ["Team | Meal | Event", "Team Lunch Selfie", "A café-table group selfie during a casual break"],
        ["Architecture | System | Presentation", "System Architecture Slide", "API, provider, and backoffice flow shown in a technical diagram"],
        ["Dashboard | Smart City | Data", "Smart City Dashboard", "A digital-twin style city visualization with live metrics"],
        ["Team | Meetup | Coffee", "Coffee Meetup", "A casual three-person café catch-up and networking moment"],
        ["Workspace | Office | Setup", "Desk Setup & Figures", "An office workstation surrounded by figurines and display pieces"],
        ["Event | Track | Selfie", "Trackside Selfie", "Looking over the pit lane during a motorsport event"],
        ["Architecture | Backend | Diagram", "System Flow Diagram", "Services, users, live stream, and provider flows mapped on one board"],
        ["Web3 | TOKEN2049 | Expo", "TOKEN2049 Entrance", "Security lanes and blue lighting at the TOKEN2049 venue entrance"],
        ["Web3 | TOKEN2049 | Showcase", "TOKEN2049 Supercar", "A sports car showcase placed inside the conference hall"],
        ["Lifestyle | Rooftop | Skyline", "Rooftop Pool Skyline", "Relaxing by the infinity pool with a dense city backdrop"],
        ["Conference | Innovation | Panel", "Innovation Funding Panel", "A panel session about Malaysia innovation funding pathways"],
        ["Conference | IP | Keynote", "IP Strategy Keynote", "A stage session on intellectual property and enterprise value"],
        ["Lifestyle | Exhibit | Pop Culture", "Simpsons Exhibit Photo", "Posing beside life-size Simpsons character figures"],
        ["Lifestyle | Celebration | Dinner", "Birthday Celebration Dinner", "A restaurant cake moment with a personal celebration feel"],
        ["Expo | Tech | Air Mobility", "Air Mobility Expo", "Standing beside the MARIi Urban Air Mobility aircraft display"],
        ["Workspace | Figures | Collection", "Collectible Figure Stack", "A stacked display of anime and stylized figures in the office"],
        ["Dashboard | Campus | Analytics", "Campus Live Stats", "A Kuala Lumpur campus screen showing active users and learning stats"],
        ["Event | Crowd | Selfie", "Night Event Crowd Selfie", "Personal event selfie in front of the Sunway Lagoon crowd"],
        ["Event | Crowd | Entrance", "Festival Entrance Crowd", "Large public event queue at the Sunway Lagoon entrance"],
        ["Team | Event | Selfie", "Conference Team Selfie", "Indoor meetup moment with event lanyards"],
        ["City | Billboard | AI", "ChatGPT Construction Billboard", "Street-side billboard about ChatGPT and construction work"],
        ["Event | Audience | Session", "Conference Audience Moment", "Indoor event audience view with lanyards and live session focus"],
        ["Community | GDG KL | Web Performance", "GDG KL Web Performance Meetup", "Community group photo from a GDG KL web performance session"],
        ["Community | Workspace | Meetup", "Startup Community Workspace", "Indoor meetup workspace with community banners and active discussions"],
        ["Event | Stage | Q&A", "Tech Event Q&A Session", "Packed audience during a live panel and Q&A session"],
        ["Hackathon | Promo | Campaign", "Can You Hack It 24H", "Hackathon campaign poster for the Can You Hack It 24H event"],
        ["Programme | Partners | Ecosystem", "Sunway KL Partner Wall", "Programme organisers and anchor partners wall at Sunway Kuala Lumpur"],
        ["Web3 | Event Kit | Badge", "Ethereum KL Event Kit", "Etherscan event bag, badge, lanyard, and swag from Ethereum Kuala Lumpur 2023"],
        ["Workspace | Coding | Session", "Late-Night Coding Session", "Focused coding session in a shared workspace with laptop and teammates in the background"],
        ["Web3 | Booth | Expo", "Ethereum KL Sponsor Booths", "Aleo and Mantle exhibitor booths at Ethereum Kuala Lumpur 2023"],
        ["Web3 | Merch | Swag", "Aleo Mantle Event Shirts", "Aleo and Mantle branded event shirts and stickers laid out after the conference"],
        ["Web3 | Booth | Giveaway", "Web3 Booth Giveaway Table", "Event booth table with MetaMask stickers, ET mugs, and Web3 handouts"],
        ["Web3 | Panel | Community", "Builder Nights Panel Session", "Packed audience during an ET Builder Nights panel and community session"],
        ["Startup | Stage | Talk", "MYStartup Dev Session", "Audience seated during a MYStartup and MyStartup Dev stage session"],
        ["AI | Conference | Stage", "AI Conference Welcome Remarks", "Large audience during welcome remarks on the main conference stage"],
        ["AI | Billboard | Street", "ChatGPT Construction Billboard", "Street-side billboard with a ChatGPT-themed construction message"],
        ["Community | Meetup | Selfie", "Workshop Meetup Selfie", "Indoor meetup selfie with lanyards after a community workshop session"],
        ["Startup | Workspace | Session", "Techstars Startup Workspace", "Startup workspace session with Techstars and Paper + Toast signage visible"],
        ["Community | Group | Photo", "Startup Community Group Photo", "Large group photo with Techstars, Remote Year, and Paper + Toast branding"],
        ["Community | Travel | Meetup", "Food Court Meetup Photo", "Casual group photo with luggage in a food court meetup setting"],
        ["Startup | Hub | Reception", "Cradle CIP Spark Visit", "Reception area with Cradle branding and CIP SPARK signage"],
      ],
      prev: "Prev",
      next: "Next",
      skip: "Skip",
    ...
    zh: {
      ...
      timelineCaptions: [
        ...
        ["成果 | IOTA | 得奖", "IOTA 得奖舞台", "马来西亚 2025 得奖舞台时刻"],
        ["创业 | 得奖 | 简报", "得奖简报舞台", "创业得奖简报时刻"],
        ["成果 | 得奖 | 舞台", "得奖舞台亮点", "活动得奖舞台时刻"],
        ["团队 | Primitive | 聚会", "Primitive 团队聚会", "与 Primitive 团队的白衣合照时刻"],
        ["团队 | 合照 | 文化", "大型团队合照", "活动现场的大型白衣团队合照"],
        ["活动 | 汽车 | 赛道", "Zeekr 赛道时刻", "夕阳下驶过 Zeekr 横幅的赛道车队"],
        ["活动 | 自拍 | 收藏", "签名海报自拍", "在商场／影院场景拿着签名板的自拍"],
        ["生活 | 天际线 | 社交", "夜景天际线聚会", "屋顶城市夜景与轻松聚会氛围"],
        ["工作区 | 桌面 | 收藏", "收藏摆件桌面", "充满玩偶与模型的轻松办公桌面"],
        ["团队 | 用餐 | 活动", "团队午餐自拍", "咖啡馆休息时的团队合照"],
        ["架构 | 系统 | 演示", "系统架构图", "展示 API、供应商与后台流程的技术架构图"],
        ["仪表板 | 智慧城市 | 数据", "智慧城市仪表板", "带实时指标的数字孪生城市可视化"],
        ["团队 | 聚会 | 咖啡", "咖啡聚会", "三人咖啡馆交流与 networking 时刻"],
        ["工作区 | 办公 | 桌设", "桌面与模型摆设", "模型与展示柜围绕的办公工位"],
        ["活动 | 赛道 | 自拍", "赛道自拍", "赛车场维修区上方的自拍视角"],
        ["架构 | 后端 | 流程图", "系统流程图", "把服务、用户、直播与供应商流程集中在一张图上"],
        ["Web3 | TOKEN2049 | 展会", "TOKEN2049 入口", "TOKEN2049 会场入口的安检与蓝色灯光氛围"],
        ["Web3 | TOKEN2049 | 展示", "TOKEN2049 超跑展示", "摆放在会场中的超跑展示台"],
        ["生活 | 屋顶 | 天际线", "屋顶泳池天际线", "在无边泳池旁看城市高楼景色"],
        ["会议 | 创新 | 论坛", "创新资金论坛", "关于马来西亚创新资金路径的台上论坛"],
        ["会议 | 知识产权 | 主题演讲", "IP 策略主题演讲", "围绕知识产权与企业价值的台上分享"],
        ["生活 | 展览 | 流行文化", "辛普森展区合照", "与真人尺寸辛普森角色模型的合照"],
        ["生活 | 庆祝 | 晚餐", "生日庆祝晚餐", "带蛋糕的餐桌庆祝时刻"],
        ["展会 | 科技 | 空中交通", "空中交通展区", "站在 MARIi Urban Air Mobility 展示机旁"],
        ["工作区 | 模型 | 收藏", "模型收藏展示", "办公室里层叠摆放的动漫与公仔收藏"],
        ["仪表板 | 校园 | 分析", "校园实时数据", "吉隆坡校区大屏展示活跃用户与学习统计"],
        ["活动 | 人群 | 自拍", "夜间活动人群自拍", "在 Sunway Lagoon 人群前的个人活动自拍"],
        ["活动 | 人群 | 入口", "活动入口人潮", "Sunway Lagoon 入口处的大型活动人流"],
        ["团队 | 活动 | 自拍", "活动团队自拍", "挂着活动证件的室内会面时刻"],
        ["城市 | 看板 | AI", "ChatGPT 建筑看板", "街头关于 ChatGPT 与建筑工作的户外看板"],
        ["活动 | 观众 | 现场", "会议观众时刻", "挂着证件的室内活动观众与现场专注时刻"],
        ["社区 | GDG KL | 网页性能", "GDG KL 网页性能聚会", "GDG KL 网页性能分享后的社区大合照"],
        ["社区 | 工作区 | 聚会", "创业社区工作区", "带有社区横幅与现场交流的室内活动工作区"],
        ["活动 | 舞台 | 问答", "科技活动问答环节", "现场座无虚席的论坛与问答时刻"],
        ["黑客松 | 宣传 | 活动", "Can You Hack It 24H", "Can You Hack It 24H 黑客松活动宣传海报"],
        ["项目 | 合作伙伴 | 生态", "Sunway KL 合作伙伴墙", "Sunway Kuala Lumpur 的项目主办方与合作伙伴展示墙"],
        ["Web3 | 活动包 | 证件", "Ethereum KL 活动包", "Ethereum Kuala Lumpur 2023 的 Etherscan 活动包、证件、挂绳与周边"],
        ["工作区 | 编码 | 时段", "深夜编码现场", "共享工作区里的专注编码时刻，背景可见队友与笔电"],
        ["Web3 | 展位 | 展会", "Ethereum KL 赞助展位", "Ethereum Kuala Lumpur 2023 现场的 Aleo 与 Mantle 展位"],
        ["Web3 | 周边 | 纪念品", "Aleo Mantle 活动 T 恤", "会后摆放的 Aleo 与 Mantle 品牌 T 恤和贴纸"],
        ["Web3 | 展位 | 赠品", "Web3 展位赠品桌", "摆有 MetaMask 贴纸、ET 马克杯与资料单的活动展位桌"],
        ["Web3 | 对谈 | 社群", "Builder Nights 对谈现场", "ET Builder Nights 对谈与社群分享时的满场观众"],
        ["创业 | 舞台 | 分享", "MYStartup Dev 现场", "观众在 MYStartup 与 MyStartup Dev 舞台分享时就座聆听"],
        ["AI | 大会 | 主舞台", "AI 大会欢迎致辞", "主会场欢迎致辞环节中的大型现场观众"],
        ["AI | 广告牌 | 街景", "ChatGPT 工地广告牌", "带有 ChatGPT 主题施工标语的街边大型广告牌"],
        ["社群 | 聚会 | 合影", "工作坊聚会自拍", "社区工作坊结束后佩戴证件绳的室内合影自拍"],
        ["创业 | 空间 | 交流", "Techstars 创业工作空间", "可见 Techstars 与 Paper + Toast 标识的创业工作空间交流场景"],
        ["社群 | 合照 | 创业", "创业社群大合照", "带有 Techstars、Remote Year 与 Paper + Toast 品牌背景的大型合照"],
        ["社群 | 出行 | 聚会", "美食广场聚会合照", "带着行李在美食广场场景中的轻松聚会合照"],
        ["创业 | 空间 | 接待处", "Cradle CIP Spark 到访", "带有 Cradle 品牌与 CIP SPARK 标识的接待区域"],
      ],
      prev: "上一个",
      next: "下一个",
      skip: "跳过",
  ...
  function setupMotionAndHelper() {
    var revealTargets = document.querySelectorAll(
      "section, #about, #services, .journal-info, .startup-icon-link, .teaching-proof-card",
    );
  ...
  function setupHackathonGlassCarousel() {
    ...
    var slideWidth = 0;
    var visibleRingRadius = 0;
    var visibleWindowRadius = 0;
    var dragStartX = 0;
    var dragStartY = 0;
    var lastPointerX = 0;
    var dragDeltaX = 0;
    ...
    function getFractionalShortestOffset(cardIndex, originIndex) {
      var diff = cardIndex - originIndex;
      var half = cards.length / 2;
    ...
    function applyCarouselLayout() {
      ...
      stableStripMode = false;
      carousel.classList.remove("is-stable-strip");
      track.style.setProperty("--carousel-rotation", "0deg");
      track.style.transform = "translate(-50%, -50%)";

      var visibleArc = window.innerWidth < 768 ? 2 : 3;
      var preloadArc = visibleArc + 2;

      cards.forEach(function (card, cardIndex) {
        var shortestOffset = getShortestOffset(cardIndex, activeIndex);
        var absOffset = Math.abs(shortestOffset);
        var thetaDeg = shortestOffset * ringStep;
        var thetaRad = (thetaDeg * Math.PI) / 180;
        var translateX = Math.sin(thetaRad) * carouselRadius;
        var translateZ = Math.cos(thetaRad) * carouselRadius - carouselRadius;
        var isFocus = absOffset === 0;
        var isSide = absOffset === 1;
        var isVisible = absOffset <= visibleArc;
        var isFarVisible = isVisible && !isFocus && !isSide;
        var isPreload = absOffset <= preloadArc;
        var isSideLeft = shortestOffset < 0 && isVisible && !isFocus;
        var isSideRight = shortestOffset > 0 && isVisible && !isFocus;
        var isBack = !isVisible;
        var cardLift = isFocus ? 72 : isSide ? 16 : Math.max(-78, -12 - absOffset * 12);
        var cardScale = isFocus ? 1.22 : isSide ? 0.96 : Math.max(0.72, 1 - absOffset * 0.08);
        var cardOpacity = !isVisible ? 0 : isFocus ? 1 : isSide ? 0.92 : Math.max(0.22, 0.82 - absOffset * 0.18);
        var cardRotateY = thetaDeg;

        card.style.setProperty("--card-lift", cardLift + "px");
        card.style.setProperty("--card-angle", thetaDeg.toFixed(2) + "deg");
        card.style.setProperty("--card-scale", String(cardScale));
        card.style.setProperty("--card-shift-x", translateX.toFixed(2) + "px");
        card.style.setProperty("--card-strip-rotate-y", "0deg");
        card.style.setProperty("--card-strip-depth", translateZ.toFixed(2) + "px");
        card.style.left = "0";
        card.style.transform = "translate3d(" + translateX.toFixed(2) + "px, " + cardLift + "px, " + translateZ.toFixed(2) + "px) rotateY(" + cardRotateY.toFixed(2) + "deg) scale(" + cardScale + ")";
        ...
        card.style.zIndex = isFocus ? "5" : isSide ? "4" : isVisible ? String(Math.max(2, visibleArc - absOffset + 2)) : "1";
        card.setAttribute("data-carousel-seq", String(cardIndex));
        card.classList.toggle("is-strip-focus", false);
        card.classList.toggle("is-strip-side", false);
        card.classList.toggle("is-strip-side-left", false);
        card.classList.toggle("is-strip-side-right", false);
        card.classList.toggle("is-strip-hidden", false);
        ...
        card.classList.toggle("is-ring-back", isBack || isFarVisible);

        if (!isPreload) {
          card.style.filter = "brightness(0.72) saturate(0.84)";
        } else {
          card.style.filter = "";
        }
      });
    ...
    function layoutRing() {
      ...
      var chordGap = window.innerWidth < 768 ? 26 : window.innerWidth < 1200 ? 34 : 42;
      var minimumTrig = Math.max(2 * Math.sin(Math.PI / cards.length), 0.01);
      var targetChord = slideWidth + chordGap;

      carouselRadius = Math.max(
        Math.round(targetChord / minimumTrig),
        Math.round(slideWidth * 1.6),
      );
      ...
      stage.style.setProperty(
        "perspective",
        window.innerWidth < 768 ? "1800px" : "2600px",
      );
  ...
  function setupLazyYouTubeEmbeds() {
    document.querySelectorAll("[data-youtube-id]").forEach(function (button) {
      if (button.getAttribute("data-youtube-deferred") === "true") {
        return;
      }
      button.addEventListener("click", function () {
  ...
  function setupStartupVideoModal() {
    var modal = document.getElementById("startup-video-modal");
    var openButton = document.querySelector("[data-startup-video-open]");
    ...
    function renderVideo() {
      ...
      if (!frameHost || !videoId || frameHost.dataset.loaded === "true") {
        return;
      }
      ...
      frame.src =
        ...
        encodeURIComponent(videoId) +
        "?rel=0&modestbranding=1&playsinline=1&autoplay=1";
      frame.title = frameHost.getAttribute("aria-label") || "YouTube video";
      frame.loading = "lazy";
      frame.referrerPolicy = "strict-origin-when-cross-origin";
      frame.allow =
        "accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture";
    ...
    function resetVideo() {
      ...
      frameHost.dataset.loaded = "false";
    ...
    function openModal() {
      ...
      modal.classList.add("is-open");
      modal.setAttribute("aria-hidden", "false");
      document.body.classList.add("startup-video-modal-open");
      modal.querySelectorAll("img[data-src]").forEach(function (image) {
        var src = image.getAttribute("data-src");
        if (src && image.dataset.loaded !== "true") {
          image.src = src;
          image.dataset.loaded = "true";
      ...
      renderVideo();
      var close = modal.querySelector(".startup-video-modal-close");
      if (close) {
        close.focus();
      }
    }
