...
assert.ok(css.includes(".startup-founder-video-hero") && css.includes("overflow: hidden") && css.includes(".startup-video-frame") && css.includes("border-radius: 16px 16px 0 0") && css.includes(".startup-sound-note") && css.includes("border-radius: 0 0 16px 16px"), "Startup video frame and sound-note footer should render as one continuous card");
